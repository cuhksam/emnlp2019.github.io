...
<tr id="poster" poster-id="3182"><td><span class="poster-title">Sequential Learning of Convolutional Features for Effective Text Classification. </span><em>Avinash Madasu and Vijjini Anvesh Rao</em>&nbsp;&nbsp;<i class="fa fa-file-pdf-o paper-icon" data="http://aclweb.org/anthology/TBD-3182" aria-hidden="true"></i></td></tr>
