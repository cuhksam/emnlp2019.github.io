...
Both long and short papers must follow the EMNLP 2018 two-column format, using the LaTeX style files or Word template to be provided on the this website. Please do not modify these style files, or use templates designed for other conferences. Submissions that do not conform to the required styles, including paper size, margin width, and font size restrictions, will be rejected without review.
